...
const langElements = {
    ...
    en: {
        wordInput: document.getElementById('wordInputEn'),
        charCount: document.getElementById('charCountEn'),
        inputError: document.getElementById('inputErrorEn'),
        startLevel2Btn: document.getElementById('startLevel2BtnEn'),
        currentLetterBig: document.getElementById('currentLetterBigEn'),
        letterProgress: document.getElementById('letterProgressEn'),
        brailleDemo: document.getElementById('brailleDemoEn'),
        toggleDemoBtn: document.getElementById('toggleDemoBtnEn'),
        brailleInput: document.getElementById('brailleInputEn'),
        level2Feedback: document.getElementById('level2FeedbackEn'),
        checkLevel2Btn: document.getElementById('checkLevel2BtnEn'),
        targetWord: document.getElementById('targetWordEn'),
        letterSlots: document.getElementById('letterSlotsEn'),
        currentPosition: document.getElementById('currentPositionEn'),
        level3BrailleInput: document.getElementById('level3BrailleInputEn'),
        level3Feedback: document.getElementById('level3FeedbackEn'),
        checkLevel3Btn: document.getElementById('checkLevel3BtnEn'),
        level4Word: document.getElementById('level4WordEn'),
        customizationSlots: document.getElementById('customizationSlotsEn'),
        previewSlots: document.getElementById('previewSlotsEn'),
        confirmColorsBtn: document.getElementById('confirmColorsBtnEn'),
        loading: document.getElementById('loading-en'),
        finalPreview: document.getElementById('finalPreviewEn'),
        restartBtn: document.getElementById('restartBtnEn'),
        final: document.getElementById('final-en'),
        level1: document.getElementById('level1-en'),
        level2: document.getElementById('level2-en'),
        level3: document.getElementById('level3-en'),
        level4: document.getElementById('level4-en')
    }
};
...
const messages = {
    ...
    en: {
        ...
        max5Letters: 'Max 5 letters',
        invalidLetter: 'Invalid letter "${char}"',
        correct: 'Correct!',
...
function getElements() {
    return langElements[gameState.language];
}

function getMessage(key) {
    const msg = messages[gameState.language][key];
    return msg;
}

function init() {
    document.getElementById('selectChinese').addEventListener('click', () => selectLanguage('zh'));
...
function selectLanguage(lang) {
    ...
    hideAllSections();
    getElements().level1.classList.add('active');
    initLevel1();
}
...
function handleWordInput() {
    ...
    if (!/^[a-zA-Z]+$/.test(value)) {
        els.inputError.textContent = getMessage('lettersOnly');
        return;
    }
    
    if (value.length > 5) {
        els.inputError.textContent = getMessage('max5Letters');
        return;
    }
    
    for (let char of value) {
        if (!isValidLetter(char)) {
            els.inputError.textContent = getMessage('invalidLetter').replace('${char}', char);
            return;
        }
    }
...
function checkLevel2Answer() {
    ...
    if (compareBrailleDots(userDots, correctDots)) {
        els.level2Feedback.textContent = getMessage('correct');
        ...
        els.level2Feedback.textContent = getMessage('incorrect');
...
function checkLevel3Answer() {
    ...
    if (compareBrailleDots(userDots, correctDots)) {
        els.level3Feedback.textContent = getMessage('correct');
        ...
        els.level3Feedback.textContent = getMessage('incorrect');
...
function switchLevel(levelId) {
    hideAllSections();
    getElements()[levelId].classList.add('active');
}
